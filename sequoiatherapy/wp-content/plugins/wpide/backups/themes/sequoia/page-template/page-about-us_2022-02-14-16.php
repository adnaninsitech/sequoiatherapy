...
if( have_rows('bottom_content') ):
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6"> <div class="img"><img src="<?php echo $image; ?>" class="rimg wow fadeInRight" data-wow-duration="4s"></div></div>
    
      <div class="col-md-6">
         <div class="rcont wow fadeInLeft" data-wow-duration="4s">
        <?php echo $content; ?>
          <a href="javascript:;" class="wow bounceIn" data-wow-duration="4s">contact me</a>
      </div>
